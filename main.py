...
size_y = 480
# title window game
pygame.display.set_caption('Snake Find Eat')
screen = pygame.display.set_mode((size_x, size_y))
grass = pygame.image.load("resources/img/air-bg2.png")
...
while True:
    ...
    # draw snake
    screen.fill(white)
    for x in range(int(size_x/grass.get_width()+1)):
        for y in range(int(size_y/grass.get_height()+1)):
    ...
    # draw food
    pygame.draw.rect(screen, yellow, pygame.Rect(food_pos[0], food_pos[1], 10, 10))
